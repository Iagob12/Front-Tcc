...
import { apiGet, apiPut, apiUploadFile, getImageUrl } from "../../config/api";
    ...
    try {
      ...
      if (responseUsuario.ok) {
        ...
        if (usuario.fotoPerfil) {
          setImagePreview(getImageUrl(usuario.fotoPerfil));
        }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (imageFile) {
        ...
        const uploadResponse = await apiUploadFile('/files/upload', formDataUpload);
